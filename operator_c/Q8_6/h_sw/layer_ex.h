...
MatF32 conv1d_f32_i8(MatF32 in_data_mat, ConvParamsI8 params) {
    // unzip input
...
void printCI8(const char *name, ConvParamsI8 mat) {
    printf("\n=> Mat %s %p [%d, %d, %d]: \n", name,
           mat.weight,
           mat.out_channels,
           mat.kernel,
