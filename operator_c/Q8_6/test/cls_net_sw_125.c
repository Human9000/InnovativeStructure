...
ConvI8 d1 = (ConvI8) {cd1_w, 12, 4, 1, 1};
ConvI8 d2 = (ConvI8) {cd2_w, 4, 4, 3, 1};
ConvB8 d3 = (ConvB8) {cd3_w, 4, 64, 3, 1};
Pool1d d4 = (Pool1d) {64, 5, 5};
ConvB8 d6 = (ConvB8) {cd6_w, 64, 4, 1, 1};
ConvI8 d7 = (ConvI8) {cd7_w, 4, 4, 3, 1};
ConvB8 d8 = (ConvB8) {cd8_w, 4, 64, 3, 1};
Pool1d d9 = (Pool1d) {64, 3, 1};
ConvB8 d11 = (ConvB8) {cd11_w, 64, 4, 1, 1};
ConvI8 d12 = (ConvI8) {cd12_w, 4, 4, 3, 1};
ConvB8 d13 = (ConvB8) {cd13_w, 4, 64, 3, 1};
Pool1d d14 = (Pool1d) {64, 5, 1};

ConvB8 u1 = (ConvB8) {cu1_w, 64, 8, 1, 1};
ConvI8 u2 = (ConvI8) {cu2_w, 8, 8, 1, 1};
ConvB8 u3 = (ConvB8) {cu3_w, 8, 64, 1, 1};
ConvB8 u6 = (ConvB8) {cu5_w, 64, 8, 1, 1};
ConvI8 u7 = (ConvI8) {cu7_w, 8, 4, 1, 1};
...
Buffer ubf1 = (Buffer) {up1_mem, 1, 64, 0};  // QConv1d(64, 8, 1),
Buffer ubf2 = (Buffer) {up2_mem, 1, 8, 0};  // QConv1d(8, 8, 1, b_weight=False),
Buffer ubf3 = (Buffer) {up3_mem, 1, 8, 0};  // QConv1d(8, 64, 1),
Buffer ubf4 = (Buffer) {up4_mem, 1, 64, 0};  // softmax(dim=1),,
//Buffer ubf5 = (Buffer) {up5_mem, 6, 64, 1};  // Upsample(4),
Buffer ubf5 = (Buffer) {up5_mem, 1, 64, 0};  // QConv1d(64, 8, 1),
Buffer ubf6 = (Buffer) {up6_mem, 1, 8, 0};  // QConv1d(8, 4, 1, b_weight=False),
Buffer ubf7 = (Buffer) {up7_mem, 1, 2, 0};  // y
